...
export default function Toolbar() {
    return (
        <div className="flex flex-row items-center border-b-1 border-b-[#EEEEEE] justify-between h-12 w-full px-2 py-[6px] gap-2">

            {/* Tool bar button */}
            <div className="flex flex-row items-center h-full gap-1 p-2">
                <span>Tool bar</span>
            ...
            <div className="flex-1 items-center flex flex-row h-full p-0 gap-1">
                {/* Hide fields button */}
                <div className="flex flex-row items-center p-2 gap-1 cursor-pointer h-full pr-3 text-[#121212]">
            ...
            <div className="flex flex-row items-center gap-2 h-full">
                ...
                <div className="flex flex-row items-center h-full gap-2">
                    {/* Import control */}
                    <button className="flex flex-row items-center gap-1 border-[#EEEEEE] border-1 p-2 rounded-md cursor-pointer h-full pr-3">
                ...
                {/* New action button */}
                <button className="flex flex-row items-center gap-1 bg-[#4B6A4F] py-2 px-6 rounded-lg justify-center cursor-pointer h-full">
